...
[`@aws-sdk/client-mturk`](https://www.npmjs.com/package/@aws-sdk/client-mturk/v/3.667.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mturk@3.667.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-veBmmOSRoHTn/UwxgljQfCdKu++hbyzeNdDcSJ4TeyEdkVwyonx9k05px5ESkbx8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mturk": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mturk@3.667.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mturk@3.667.0/index.min.mjs": "sha384-veBmmOSRoHTn/UwxgljQfCdKu++hbyzeNdDcSJ4TeyEdkVwyonx9k05px5ESkbx8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mturk/blob/refs/tags/3.667.0/LICENSE
```
